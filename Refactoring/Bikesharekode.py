...
## TESTING editing in codetext
## Filenames
#chicago = 'chicago.csv'
#new_york_city = 'new_york_city.csv'
#washington = 'washington.csv'
#New tesing of change
...
def get_city():
    ...
    while city.lower() not in ['chicago', 'new york', 'washington']:
        city = input('\nHey! Will you explore some US bikeshare data?\n'
                     'You can chose Chicago, New York, or'
                     ' Washington?\n')
        if city.lower() == 'chicago':
            ...
            print('Please input one of these '
...
def statistics():
    ...
    city = get_city()
    print('Loading this incredible code of Ole Petter  :)')
    ...
    # Display five lines of data at a time
